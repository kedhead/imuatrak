...
export const metadata: Metadata = {
  ...
  description:
    "Paddling tracker for iPhone, Apple Watch & Android — free on the App Store and Google Play. GPS, stroke rate, splits, heart rate. Built for OC1, OC6, dragon boat, surfski, V1 and SUP. Imua — charge forward.",
